#!/usr/bin/env python3
"""
SwarmSignal-9B Training Script — Blackwell Edition
=====================================================

bf16 full LoRA on RTX PRO 6000 Blackwell (96GB).
30K AI trends writer pairs from Together.ai cook.

Base model:  Qwen/Qwen3.5-9B
Method:      bf16 LoRA r=64 (full precision — 96GB VRAM)
GPU:         RTX PRO 6000 Blackwell 96GB (CUDA_VISIBLE_DEVICES=1)
Data:        ~28.5K train + 1.5K eval (AI trends writer pairs)
Output:      /data2/swarmsignal-9b/

Run:
    CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=1 \
    WANDB_MODE=disabled python3 train_swarmsignal_9b.py
"""
...
OUTPUT_DIR  = Path("/data2/swarmsignal-9b")
DATA_DIR    = Path("/data2/swarmsignal-9b/data")
TRAIN_FILE  = DATA_DIR / "swarmsignal_train.jsonl"
EVAL_FILE   = DATA_DIR / "swarmsignal_eval.jsonl"
